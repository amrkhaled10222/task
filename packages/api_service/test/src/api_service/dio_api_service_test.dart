  ...
  group('DioApiService', () {
    ...
    test(
      ...
      when(dio.get(any)).thenAnswer(
        (_) async => Response(data: expectedResponse, statusCode: 200, requestOptions: RequestOptions()),
      );

      final result = await dioApiService.get('path', fromJson: (data) => data);

      expect(result, equals(expectedResponse));
      verify(dio.get(any, queryParameters: anyNamed('queryParameters'))).called(1);
    });
    ...
    test(
      ...
      final result = await dioApiService.getList('path', fromJson: (data) => data);
    ...
    test(
      ...
      expect(result, equals(expectedResponse));
      verify(dio.post(any, queryParameters: anyNamed('queryParameters'))).called(1);
    });
    ...
    test(
      ...
      expect(result, equals(expectedResponse));
      verify(dio.put(any, queryParameters: anyNamed('queryParameters'))).called(1);
    });
    ...
    test(
      ...
      final result = await dioApiService.delete('path', fromJson: (data) => data);

      expect(result, equals(expectedResponse));
      verify(dio.delete(any, queryParameters: anyNamed('queryParameters'))).called(1);
    });
  });
}
